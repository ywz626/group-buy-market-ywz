package com.ywz.test.tag;


import com.ywz.domain.tag.service.ITagService;
...
public class ITagServiceTest {
    ...
    public void test_get_tag_bitmap() {
        ...
        log.info("gudebai 不存在，预期结果为 false，测试结果:{}", bitSet.get(redisService.getIndexFromUserId("ywz")));
    }
